              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-gray-900">Aperçu du résultat</h2>
                      <p className="text-xs text-gray-500">Votre CV personnalisé est prêt</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border-2 border-dashed border-gray-300 p-12">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 max-w-sm mx-auto">
                    Remplissez le formulaire à gauche et cliquez sur "Générer" pour voir
                    votre CV personnalisé apparaître ici.
                  </p>
                </div>
              </div>
            )}
