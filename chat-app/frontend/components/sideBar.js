...
export default function Sidebar({
          ...
          {conversations.map((conv) => (
            ...
            >
              <button
                ...
                className="w-full text-left p-3 pr-10 flex items-start gap-3"
              >
                <div className={`mt-0.5 flex-shrink-0 ${currentConversationId === conv.id ? 'text-white' : 'text-gray-400'}`}>
              ...
              {showDeleteConfirm === conv.id && (
                <div className="absolute inset-0 bg-gray-900/95 backdrop-blur-sm rounded-xl p-3 flex flex-col justify-center gap-2 z-10 shadow-xl border border-gray-700">
                  <p className="text-xs text-center text-gray-200 font-medium">Supprimer cette conversation ?</p>
  ...
  return (
    <div className="w-80 bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white flex flex-col h-screen shadow-2xl border-r border-gray-800">
      {/* Header avec logo */}
      <div className="p-4 border-b border-gray-800/50">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Groq Intelligence</p>
          </div>
        </div>

        <button
          onClick={onNewConversation}
          className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all font-medium shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-[1.02]"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center text-gray-500 mt-16 px-4">
            {searchQuery ? (
              <>
                ...
                <p className="text-xs mt-2 text-gray-600">Essayez un autre terme de recherche</p>
              </>
            ) : (
              <>
                ...
                <p className="text-xs mt-2 text-gray-600">Créez-en une pour commencer</p>
              </>
            )}
          </div>
        ) : (
      ...
      <div className="p-4 border-t border-gray-800/50 bg-gradient-to-t from-black/50 to-transparent backdrop-blur-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="w-11 h-11 bg-gradient-to-br from-green-500 to-teal-600 rounded-xl flex items-center justify-center font-bold text-lg shadow-lg shadow-green-500/20">
