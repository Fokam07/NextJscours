    ...
    >
      ...
      <div className="p-4 space-y-4">
        <button
          ...
          className='w-full h-11 mb-4 bg-white/[0.03] hover:bg-white/[0.06] text-white border border-white/10 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95'
